...
# todo 为什么要这么写？ 是 只能 feature + label？
...
model.fit(create_tf_dataset(dataset), epochs = 20,  validation_data=create_tf_dataset(valid_data), callbacks = [early_stopping, tensorboard_callback])
